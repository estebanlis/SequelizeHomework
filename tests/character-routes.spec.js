...
describe('Character Routes', () => {
  ...
  describe('POST /character', () => {
    ...
    xit('should return status 201 and character object if the character was succesfully created', async () => {
      ...
      expect(res.body).toEqual({
        ...
        mana: 120.0,
        age: null,
        date_added: new Date().toISOString().splxit('T')[0],
        race: 'Other'
      });
    });
  ...
  describe('Multiple routes', () => {
    ...
    xit('should return status 200 and the list of all characters', async () => {
      ...
      expect(res.body).toEqual([
        {code: 'ONE', name: 'First', hp: 90.0, mana: 150.0, age: 27, date_added: new Date().toISOString().splxit('T')[0], race: 'Human'},
        {code: 'TWO', name: 'Second', hp: 135.0, mana: 40.0, age: 20, date_added: new Date().toISOString().splxit('T')[0], race: 'Machine'},
        {code: 'THREE', name: 'Third', hp: 110.0, mana: 110.0, age: 23, date_added: new Date().toISOString().splxit('T')[0], race: 'Human'}
      ])
    })
